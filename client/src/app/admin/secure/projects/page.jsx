...
export default function Page() {
  ...
  const handleDelete = async () => {
    setOpenDelete(!openDelete);
    try {
      const res = await axiosInstance.delete(`/project/${deleteId}`);
  ...
  return (
    <div className="lg:px-10 px-8 py-8 lg:pt-8 pt-24">
      ...
      <div className="flex justify-between py-5">
        <div className=""></div>
        <Link
          href={"/admin/secure/projects/create"}
              ...
              <table className="table-auto w-full">
                <thead>
                  <tr className="py-5 bg-gray-200 w-full ">
                    ...
                    <th className="lg:px-8 px-5 py-5 ">Title</th>
                    <th className="lg:px-8 px-5 py-5 ">Subtitle</th>
                    <th className="lg:px-8 px-5 py-5 ">githubUrl</th>
                    <th className="lg:px-8 px-5 py-5 ">liveUrl</th>
                ...
                <tbody>
                  {projects.map((project) => (
                    <tr key={project._id}>
                      ...
                      <td className="px-5 text-center py-3">{project.title}</td>
                                ...
                                <div className=" min-w-fit text-sm bg-white">
                                  <ul>
                                    ...
                                    <li className="mb-2 hover:text-black">
                                      <Link
                                        href={`/admin/secure/projects/update/${project._id}`}
                                      >
                                        Edit
                                      </Link>
                                    </li>
