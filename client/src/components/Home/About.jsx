...
const About = () => {
  return (
    <div className="">
      ...
      <div className="bg-black text-white py-5 my-5">
        <div className="">
          <Marquee className=" overflow-hidden text-2xl flex">
            {marq.map((mq, i) => {
              return (
                <div key={i} className="flex items-center">
                  <h1 className="ml-2 mr-2 uppercase md:mr-2 text-sm tracking-widest font-light">
                    {mq}
                  </h1>
                  <div className="font-bold tracking-wider mt-auto mb-auto">
                    <RiShining2Fill className="text-orange-400 m-auto text-xl " />
                  </div>
                </div>
              );
            })}
